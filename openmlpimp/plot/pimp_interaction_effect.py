...
def parse_args():
    ...
    parser.add_argument('--result_directory', type=str, default=os.path.expanduser('~') + '/experiments/fanova/triples/rf', help='the directory to load the experiments from')
...
if __name__ == '__main__':
    ...
    for task_id in os.listdir(args.result_directory):
        task_dir = os.path.join(args.result_directory, task_id)
    ...
    print(num_tasks, total_ranks)
    sorted_values, keys = determine_relevant(marginal_contribution, max_interactions=2)
